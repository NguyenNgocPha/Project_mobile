...
import com.example.motobike.listener.IRecyclerClickListener
...
var useCart =FirebaseDatabase.getInstance()
    .getReference("Cart")
        ...
        useCart.child(drinkModel.key!!)
            .addListenerForSingleValueEvent(object:ValueEventListener{
                ...
                override fun onDataChange(snapshot: DataSnapshot) {
                    if(snapshot.exists()){
                        var cartModel=snapshot.getValue(CartModel::class.java)
